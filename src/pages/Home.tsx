          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center md:items-center w-full md:w-auto mb-2 md:mb-4">
                ...
                <div className="flex items-center justify-center space-x-2.5 md:space-x-4">
                  <div className="w-4 md:w-8 h-[1px] bg-secondary" />
                  <span className="text-secondary tracking-[0.25em] text-[10px] sm:text-xs md:text-sm uppercase font-medium drop-shadow-md whitespace-nowrap">{SLIDES[currentSlide].subtitle}</span>
